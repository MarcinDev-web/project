...
import type { BlockDefinition, BlockCategory, BlockMaterialType } from '../../rendering/blocks/BlockLibrary';
import type { RgbaColor } from '../../utils/colors';
import type { CTMPattern } from '../../rendering/textures/ConnectedTextures';
import { ProceduralTextureGenerator } from '../../rendering/textures/ProceduralTextureGenerator';
...
export class BlockEditorUI {
  ...
  public deleteFromStorage(blockId: string): boolean {
    try {
      ...
      import('../../logger').then(({ Logger }) => Logger.error('Failed to delete custom block:', error as unknown as Error)).catch(() => {});
      return false;
    }
  }
