...
describe('Marketplace Routes Integration', () => {
  ...
  function createMockDependencies(): RouteDependencies {
    return {
      ...
      avatarStorage: {
        initialize: async () => {},
        createPreset: async () => ({ id: 'test', userId: 'test', name: 'test', avatarData: {}, tags: [], isPublished: false, createdAt: 0, updatedAt: 0 }),
        getPreset: async () => null,
        getPresets: async () => [],
        updatePreset: async () => ({ id: 'test', userId: 'test', name: 'test', avatarData: {}, tags: [], isPublished: false, createdAt: 0, updatedAt: 0 }),
        deletePreset: async () => {},
      } as any,
