 ...
 */
export function convertBlocksToAssets(blockLibrary) {
    const assets = [];
...
function mapBlockCategoryToAssetCategory(category) {
    const mapping = {
        basic: 'Building',
        natural: 'Nature',
...
function mapBlockCategoryToSubcategory(category) {
    const mapping = {
        basic: 'Walls',
        natural: 'Rocks',
...
function mapMaterialToStyle(material) {
    const mapping = {
        plastic: 'Cartoon',
        stone: 'Rustic',
        wood: 'Rustic',
...
function mapBlockMaterialToAssetMaterial(material) {
    const mapping = {
        plastic: 'Plastic',
        stone: 'Stone',
        wood: 'Wood',
 ...
 */
function createColorVariants(assetId, baseColors) {
 ...
 */
export function getAllBuiltInAssets(blockLibrary) {
 ...
 */
export async function initializeAssetLibrary(registry, blockLibrary) {
