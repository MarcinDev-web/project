...
const DEFAULT_PART_DEFINITIONS: AvatarPartDefinition[] = [
  ...
  },
  {
    ...
    localRotation: IDENTITY_QUAT,
    localScale: [0.22, 0.16, 0.08], // More rounded, less flat - sphere with flattened depth
  ...
  ...createMirroredParts({
    ...
    jointLeft: 'Foot.L',
    jointRight: 'Foot.R',
    localPosition: [0, -0.05, 0.12], // Pivot at heel, toe extends 0.12 forward
    localScale: [0.24, 0.12, 0.3], // Flat foot (Y=0.12), elongated (Z=0.3)
    defaultColor: COLOR_SHOE,
    mesh: 'capsule_y', // Rounded foot shape instead of block
  }),
  {
    id: 'backpack_default',
