...
export class PlayerDetection {
    ...
    playerCheckInterval = 1000; // Check every second
    constructor(scene) {
        this.scene = scene;
    }
    /**
     ...
     */
    checkPlayerLeft(position, radius, wasInside) {
        const isInside = this.isPlayerNear(position, radius);
        return wasInside && !isInside;
    }
    /**
     ...
     */
    getClosestEntity(position, maxDistance) {
        let closest = null;
...
//# sourceMappingURL=PlayerDetection.js.map