...
export class BoundingVolume {
     ...
     */
    static fromCenterSize(center, halfSize) {
        return {
            min: [
                center[0] - halfSize[0],
                center[1] - halfSize[1],
     ...
     */
    static fromEntity(entity, physics) {
