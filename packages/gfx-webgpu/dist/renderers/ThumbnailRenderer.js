...
import { createGeometryBuffers, createPipelines, createTextureAtlas, createUniformResources, } from '../resources/resources';
import { DEFAULT_GEOMETRY } from '../resources/resources';
import { FOV_RADIANS, UNIFORM_BUFFER_SIZE, UNIFORM_DATA_LENGTH, Z_FAR, Z_NEAR, TEXTURE_SIZE, } from '../config';
export class ThumbnailRenderer {
     ...
     */
    async renderAsset(preset, options) {
        if (!this.device)
        ...
        mat4Perspective(projectionMatrix, FOV_RADIANS, 1, Z_NEAR, Z_FAR);
        ...
        device.queue.writeBuffer(uniformBuffer, 128, new Float32Array([
            materialsPerRow,
        ...
        copyEncoder.copyTextureToBuffer({ texture: colorTexture }, { buffer: readBuffer, bytesPerRow }, { width: size, height: size });
...
//# sourceMappingURL=ThumbnailRenderer.js.map