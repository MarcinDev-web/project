export class TonemapLutPass {
    ...
    initialize(presentationFormat) {
        ...
        if (!this.lutTexture) {
            ...
            this.device.queue.writeTexture({ texture: this.lutTexture }, data, { bytesPerRow: size * 4, rowsPerImage: size }, { width: size, height: size, depthOrArrayLayers: size });
        }
...
//# sourceMappingURL=TonemapLut.js.map