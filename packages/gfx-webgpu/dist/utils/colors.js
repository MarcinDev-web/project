 ...
 */
export function lightenColorInPlace(color, amount) {
 ...
 */
export function copyRgba(dst, src) {
    dst[0] = src[0];
    dst[1] = src[1];
    dst[2] = src[2];
    dst[3] = src[3];
...
export function hexToRgba(hex) {
    ...
    const isValidLength = hexBody.length === 3 || hexBody.length === 4 || hexBody.length === 6 || hexBody.length === 8;
