...
- Redis Cache & Pub/Sub (Nowość Nov 2025)
- WebSocket support
- Asset storage
- User management
- Forum, marketplace, studio

**Zależności:** Express, Prisma, WebSocket, Redis (ioredis)
...
**Funkcje:**
- WebRTC signaling
- Room management (Stateless w oparciu o Redis)
- Real-time synchronization
- Session handling
- Distributed Locks & Pub/Sub

**Zależności:** WebSocket, WebRTC, Redis (ioredis)
